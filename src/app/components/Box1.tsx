...
//         {/* Content */}
//         <div className="pr-3 pl-2 py-5 w-full flex flex-col items-center gap-4 xl:gap-5">
//           {/* Tabs */}
//           <div className="p-2 flex xl:gap-3 bg-neutral-900 w-full rounded-3xl text-[#A3ADB2] text-[12px] xl:text-lg font-bold ">
//             {["About Me", "Experience", "Recommended"].map((tab) => (
//               <Link
//                 key={tab}
//                 href="#"
