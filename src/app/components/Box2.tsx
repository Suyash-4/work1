    ...
    <div className="h-full w-full overflow-hidden bg-[#363c43] rounded-3xl shadow-[5px_4px_10px_rgba(0,0,0,0.6)] flex ">
      ...
      <div className="p-3 h-full w-full overflow-hidden ">
        ...
        <div className="w-full flex items-center gap-10 xl:gap-20 justify-center md:justify-between">
          {/* Top Buttons */}
          <div className="shadow-[inset_0px_0px_10px_rgba(0,0,0,0.7)] bg-neutral-900  px-4 py-2 xl:px-9 xl:py-4 rounded-3xl w-fit text-[10px] xl:text-lg">
            <h1>Gallery</h1>
          </div>
          {/* plus, and arrowsss ->> */}
          <div className="flex gap-2 lg:gap-5 items-center">
            ...
            <div className="flex gap-2 xl:gap-3 items-center">
              <button className="custom-prev">
                <HiArrowSmallLeft className="bg-zinc-800 rounded-full size-8 xl:size-12 p-2 shadow-[inset_1px_3px_10px_rgba(255,255,255,0.1),-5px_-6px_8px_#3D4854,6px_6px_14px_#22272C] text-[#6F787C]" />
              </button>
              <button className="custom-next">
                <HiArrowSmallRight className="bg-zinc-800 rounded-full size-8 xl:size-12 p-2 shadow-[inset_1px_3px_10px_rgba(255,255,255,0.1),-5px_-6px_8px_#3D4854,6px_6px_14px_#22272C] text-[#6F787C]" />
              </button>
            </div>
          </div>
        </div>
